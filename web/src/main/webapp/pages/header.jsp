				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header">
							...
							<br><br>
							昵称：&nbsp;&nbsp; <strong style="color: white"><security:authentication property="principal.username"/>&nbsp;&nbsp;<br></strong>
							状态：<span style="color: white"><i class="fa fa-circle text-success"></i> 在线</span>
						</li>
